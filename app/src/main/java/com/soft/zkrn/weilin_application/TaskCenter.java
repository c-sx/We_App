...
public class TaskCenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tool.addSelectedViews(new View[]{tv_whole}).addSelectedViews(new View[]{tv_publish}).addSelectedViews(new View[]{tv_complete}).addSelectedViews(new View[]{tv_comment});
        tool.setFragments(Task_CenterWhole.class, Task_CenterPublish.class, Task_CenterComplete.class,Task_CenterComment.class);
